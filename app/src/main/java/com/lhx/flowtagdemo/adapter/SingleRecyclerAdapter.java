...
import com.lhx.flowtagdemo.SingleChoiceActivity;
...
public class SingleRecyclerAdapter extends RecyclerView.Adapter<SingleRecyclerAdapter.ViewHolder> {
    ...
    public SingleRecyclerAdapter(Context mContext, List<TestBean> mListData) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        Set<Integer> positionSet = SingleChoiceActivity.positionSet;
